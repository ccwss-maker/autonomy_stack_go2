...
void readParameters(rclcpp::Node::SharedPtr node)
{
  ...
  declare_and_get_parameter<bool>(node, "publish.velocity_pub_en", velocity_pub_en, false);
  declare_and_get_parameter<std::string>(node, "publish.velocity_topic", velocity_topic, "/sportmodestate_lin_vel");
